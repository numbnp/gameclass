...
rem GCViewer
copy Output\Release\gcviewer.exe Install\Src\Packages\GCViewer >>Install\Src\Logs\CopyPackagesFiles.log| ech .
copy Output\Release\winhkg.dll Install\Src\Packages\GCViewer >>Install\Src\Logs\CopyPackagesFiles.log| ech .
