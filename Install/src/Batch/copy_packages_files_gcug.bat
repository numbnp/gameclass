...
del /s /q Install\Src\Packages\GCUG\*.* >nul 2>nul
echo  OK
...
rem GCTI
copy Output\Release\gcugcfg.exe Install\Src\Packages\GCUG >>Install\Src\Logs\CopyPackagesFiles.log| ech .
copy Output\Release\gcugsrv.exe Install\Src\Packages\GCUG >>Install\Src\Logs\CopyPackagesFiles.log| ech .
copy Docs\Help\gcug.chm Install\Src\Packages\GCUG >>Install\Src\Logs\CopyPackagesFiles.log| ech .
