...
del /s /q Install\Src\Packages\GCTI\*.* >nul 2>nul
echo  OK
...
rem GCTI
copy Output\Release\gcticfg.exe Install\Src\Packages\GCTI >>Install\Src\Logs\CopyPackagesFiles.log| ech .
copy Output\Release\gctisrv.exe Install\Src\Packages\GCTI >>Install\Src\Logs\CopyPackagesFiles.log| ech .
copy Docs\Help\gcti.chm Install\Src\Packages\GCTI >>Install\Src\Logs\CopyPackagesFiles.log| ech .
