...
del /s /q Install\Src\Packages\GCSync\*.* >nul 2>nul
echo  OK
...
rem Database
copy DataBase\dbsync.xml Install\Src\Packages\GCSync >>Install\Src\Logs\CopyPackagesFiles.log| ech .
copy Output\Release\GCosql.exe Install\Src\Packages\GCSync >>Install\Src\Logs\CopyPackagesFiles.log| ech .
rem GCSync
copy Output\Release\gcsyncsrv.exe Install\Src\Packages\GCSync >>Install\Src\Logs\CopyPackagesFiles.log| ech .
copy Output\Release\gcsynccfg.exe Install\Src\Packages\GCSync >>Install\Src\Logs\CopyPackagesFiles.log| ech .
