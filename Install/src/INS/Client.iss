...
#define MyAppVersion "3.85.2.10.1 Free"
...
[Run]
Filename: "{app}\Client\gcclsrv.exe"; Parameters: "-install -silent"
Filename: net; Parameters: "start gcclsrv"; Flags: RunHidden; 
Filename: netsh; Parameters: "firewall add allowedprogram ""{app}\Client\gccl.exe"" GCClient ENABLE"; Flags: RunHidden; 
Filename: netsh; Parameters: "firewall add allowedprogram ""{app}\Client\gcclsrv.exe"" GCClientService ENABLE"; Flags: RunHidden; 
...
Filename: cmd; Parameters: "/c ""{app}\Client\gcclsrv.exe"" -uninstall -silent"; Flags: RunHidden; 
Filename: cmd; Parameters: "/c del ""{app}\Client\gcclsrv.exe"""; Flags: RunHidden; 
Filename: cmd; Parameters: "/c del ""{app}\Client\*.log"" /Q"; Flags: RunHidden;
