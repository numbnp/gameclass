    ...
    if ContainedExtraInfo then begin
      try
        if (FnSpeed = 0) then begin
          TI.APISetAttr(3, ExtraInfo, User_BandwidthDef, True, True);
        end else begin
          TI.APISetAttr(3, ExtraInfo, User_BandwidthDef, False, True);
          TI.APISetAttr(3, ExtraInfo, User_InBandwidth, FnSpeed, True);
        end;
      except
