object ClientAssistant: TClientAssistant
  ...
  object Notebook: TNotebook
    ...
    object TPage
      ...
      object Label1: TLabel
        ...
        AutoSize = False
        Caption = 
          'This is the TPageManager component demonstration form. You can u' +
    ...
    object TPage
      ...
      object EditBIRTH_DATE: TDBDateEdit
        Left = 142
        Top = 177
        Width = 110
        Height = 21
      ...
      object EditDATE_OPEN: TDBDateEdit
        Left = 271
        Top = 55
        Width = 93
        Height = 21
      ...
      object ComboRISK_LEVEL: TRxDBComboBox
        Left = 142
        Top = 226
        Width = 87
        Height = 21
  ...
  object PageManager: TPageManager
    PageOwner = Notebook
    NextBtn = NextBtn
    PriorBtn = BackBtn
    ...
    Left = 32
    Top = 294
    object ToDo: TPageProxy
      PageName = 'ToDo'
      OnLeave = ToDoLeave
    end
    object SearchConfirm: TPageProxy
      PageName = 'SearchConfirm'
    end
    object SearchParams: TPageProxy
      PageName = 'SearchParams'
      OnLeave = SearchParamsLeave
    end
    object ClientsBrowse: TPageProxy
      PageName = 'ClientsBrowse'
      OnLeave = ClientsBrowseLeave
      OnShow = ClientsBrowseShow
    end
    object ClientEdit: TPageProxy
      PageName = 'ClientEdit'
  ...
  object SearchQuery: TRxQuery
    ...
    SQL.Strings = (
      ...
      '  CLIENTS."FIRST_NAME"')
    Macros.Data = {
      010005000A46495253545F4E414D4501010400303D30000001094C4153545F4E
      414D4501010400303D30000001044349545901010400303D3000000105535441
      544501010400303D300000010A4F434355504154494F4E01010400303D300000
      01}
    Left = 208
    Top = 292
