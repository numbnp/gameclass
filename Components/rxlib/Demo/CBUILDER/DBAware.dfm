object DBAwareForm: TDBAwareForm
  ...
  object PicClip: TPicClip
    ...
    Picture.Data = {
      ...
      0000200000000100040000000000000300000000000000000000000000000000
  ...
  object rxQuery1: TRxQuery
    ...
    SQL.Strings = (
      ...
      ' ORDERS."SaleDate" , CUSTOMER."Company" , '
      ' ORDERS."CustNo" , '
      ' ORDERS."ShipDate" , '
      ...
      ' ORDERS."ShipToPhone" , '
      ' ORDERS."ShipVIA" , ORDERS."PO" , '
      ' ORDERS."Terms" , '
      ' ORDERS."PaymentMethod" , '
      ' ORDERS."ItemsTotal" , ORDERS."TaxRate" , '
      ' ORDERS."Freight" , ORDERS."AmountPaid",'
      ' ORDERS."EmpNo" , EMPLOYEE."LastName" '
      ...
      'ORDER BY %ORDER')
    Macros.Data = {
      0100040008435553544F4D455201010400303D3000000108454D504C4F594545
      01010400303D300000010853414C454441544501010400303D30000001054F52
      4445520101090053616C6544617465000001}
    Left = 208
