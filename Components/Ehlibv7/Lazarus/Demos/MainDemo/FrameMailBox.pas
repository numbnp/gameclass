...
var
  FilePath: String;
begin
  if FileExists(ExtractFilePath(ParamStr(0))+'\Letters.mdb') { *Converted from FileExists* } then
    FilePath := ExtractFilePath(ParamStr(0))+'\Letters.mdb'
  else if FileExists(ExtractFilePath(ParamStr(0))+'..\Data\Letters.mdb') { *Converted from FileExists* } then
    FilePath := ExtractFilePath(ParamStr(0))+'..\Data\Letters.mdb'
  else if FileExists(ExtractFilePath(ParamStr(0))+'..\..\..\Data\Letters.mdb') { *Converted from FileExists* } then
    FilePath := ExtractFilePath(ParamStr(0))+'..\..\..\Data\Letters.mdb';

{  SQLConnectionProviderEh1.InlineConnection.ConnectionString :=
