object DBGridEhSimpleFilterDialog: TDBGridEhSimpleFilterDialog
  ...
  object Label1: TLabel
    ...
    Width = 229
    Height = 13
    Caption = 'Відображати тільки ті записи, значення яких:'
  end
  ...
  object Label2: TLabel
    ...
    Width = 217
    Height = 13
    Caption = 'Символ ''_'' означає один будь-який символ'
  end
  object Label3: TLabel
    ...
    Width = 271
    Height = 13
    Caption = 'Символ ''%'' означає послідовність будь-яких символів'
  end
