object DBGridEhSimpleFilterDialog: TDBGridEhSimpleFilterDialog
  ...
  Caption = 'Пользовательский фильтр'
  ClientHeight = 218
  ClientWidth = 410
  Color = clBtnFace
  ...
  object Label1: TLabel
    ...
    Width = 100
    Height = 13
    Caption = 'Показывать только те записи, значения которых:'
  end
  ...
  object Label2: TLabel
    ...
    Width = 189
    Height = 13
    Caption = 'Знак '#39'_'#39' обозначает один любой знак'
  end
  object Label3: TLabel
    ...
    Width = 208
    Height = 13
    Caption = 'Знак '#39'%'#39' обозначает последовательность любых знаков'
  end
