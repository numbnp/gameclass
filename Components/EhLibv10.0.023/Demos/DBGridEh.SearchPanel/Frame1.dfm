object frFrame1: TfrFrame1
  ...
  object Button2: TButton
    ...
    Height = 25
    Anchors = [akLeft, akBottom]
    Caption = 'Dynamic Show Search Panel'
    TabOrder = 1
  ...
  object Button3: TButton
    ...
    Height = 25
    Anchors = [akLeft, akBottom]
    Caption = 'Search Panel In Grid Top'
    TabOrder = 2
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object Panel2: TPanel
        ...
        object Label1: TLabel
          ...
          Width = 184
          Height = 13
          Caption = 'Demo 1. Base features of SearchPanel'
        end
      end
    ...
    object TabSheet2: TTabSheet
      ...
      object DBMemoEh1: TDBMemoEh
        ...
        Height = 352
        Lines.Strings = (
          'The Demo shows how to use SeachPanel properties to customize it:'
          ''
          'DBGridEh1.SearchPanel.FilterOnTyping'
          ''
          'DBGridEh1.SearchPanel.PersistentShowing'
          ''
          'DBGridEh1.SearchPanel.FilterEnabled'
          ''
          'DBGridEh1.SearchPanel.Location')
        Align = alClient
        AutoSize = False
        DynProps = <>
        EditButtons = <>
