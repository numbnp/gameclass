  ...
  object Panel1: TPanel
    ...
    object Memo1: TMemo
      ...
      Lines.Strings = (
          ...
          'Assume that we do not know whether the child nodes exist for par' +
          'ent node.'
        'It puts a '#39'+'#39' sign for newly loaded nodes.'
        
          'TMemTableEh.OnRecordsViewTreeNodeExpanding event is used to chec' +
          'k and download child nodes. '
        
          'Press '#39'+'#39' sign and look at SQL Monitor window to understand how ' +
          'it interact with DataBase.')
      ParentColor = True
      ReadOnly = True
      TabOrder = 1
      WordWrap = False
