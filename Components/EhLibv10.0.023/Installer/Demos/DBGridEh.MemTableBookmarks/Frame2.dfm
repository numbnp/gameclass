object frFrame2: TfrFrame2
  ...
  object DBGridEh2: TDBGridEh
    ...
    Height = 510
    Align = alClient
    AllowedSelections = [gstRecordBookmarks, gstRectangle]
    ColumnDefValues.Title.TitleButton = True
  ...
  object Panel2: TPanel
    ...
    object Memo1: TMemo
      ...
      Ctl3D = False
      Lines.Strings = (
        'Select rows in the left Grid.'
        'Right Grid fills with selected rows synchronously.'
        'Used events:'
        '  TDBGridEh.OnSelectedRowsItemChanged'
        '  TDBGridEh.OnSelectionChanged')
      ParentCtl3D = False
      ReadOnly = True
      TabOrder = 0
    end
