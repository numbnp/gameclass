...
{ TApplicationLanguageConsts }
  ...
  published
    ...
    property VertMenuCellButtons: string read FVertMenuCellButtons write FVertMenuCellButtons;//Cell Buttons
...
begin
  ...
  VertMenuCellButtons := 'Cell Buttons';
