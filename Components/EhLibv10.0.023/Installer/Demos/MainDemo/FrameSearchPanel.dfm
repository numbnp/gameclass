object frSearchPanel: TfrSearchPanel
  ...
  object Panel2: TPanel
    ...
    object Button6: TButton
      ...
      Width = 200
      Height = 25
      Caption = 'FitlerPanel in the Top'
      TabOrder = 3
  ...
  object PopupMenu1: TPopupMenu
    Left = 552
    Top = 8
    object ppmTopGrid: TMenuItem
      Caption = 'SearchPanel in the Grid Top'
      OnClick = ppmTopGridClick
    end
    object ppmInScrollBar: TMenuItem
      Caption = 'SearchPanel in the ScrollBar ExtraPanel'
      OnClick = ppmInScrollBarClick
    end
    object ppmCellInplace: TMenuItem
      Caption = 'SearchPanel in the Cell (Inplace)'
      OnClick = ppmCellInplaceClick
    end
  end
end
