...
rem Компиляция
set DCCFlags=GCTI,ASPROTECT
set DCCProjectPath=InternetPlugins\TrafficInspector
set DCCProjectName=GCTICfg
set DCCReturnPath=..\..
call Install\Src\Batch\compile_project.bat
set DCCProjectName=GCTISrv
call Install\Src\Batch\compile_project.bat
