...
// PASTLWTR : 1.2
// File generated on 22.10.2007 15:29:49 from Type Library described below.

// ************************************************************************  //
// Type Lib: Z:\Program Files\TrafInsp\TrafInsp.exe (1)
// LIBID: {3786FCCA-9365-4E47-8AF5-565C5D0A3FBD}
// LCID: 0
// Helpfile: 
// HelpString: Traffic inspector service type library
// DepndLst: 
...
const
  ...
  IID_IBasicAdmin: TGUID = '{FBC7B5C1-5F6A-4283-BBA8-156BB1923EF5}';
...
const
  ...
  User_LastAnyTraffActive = $0000004E;
  User_ProxyAutoConfigDef = $0000004F;
  User_VLAN = $00000050;
  User_VLANDef = $00000051;
  User_VLANAlterIP = $00000052;
  User_VLANAlterMAC = $00000053;
  User_CheckAgentTimeStamp = $00000054;
  User_StaticARP = $00000055;
  User_AgentXSLPage = $00000056;
...
const
  ...
  Group_ProxyAutoConfig = $00000019;
  Group_ProxyAutoConfigDef = $0000001A;
  Group_VLAN = $0000001B;
  Group_AgentXSLPage = $0000001C;
...
const
  ...
  conf_AttrLevelRootOnly = $00000003;
  conf_AttrLevelWORoot = $00000004;
  conf_AttrLevelDetail = $00000005;
  conf_AttrLevelPreview = $00000006;
...
const
  ...
  itSMTPSend = $0000000A;
  itSMTPServRule = $0000000B;
  itWWWServConfig = $0000000C;
  itWWWServRedirect = $0000000D;
  ...
  itIPNetDesc = $00000015;
  itURLDesc = $00000016;
  itProxyRoute = $00000017;
...
// Constants for enum SMTPTraceLogAttrDefs
type
  SMTPTraceLogAttrDefs = TOleEnum;
const
  TraceLog_Time = $00000000;
  TraceLog_ClientIP = $00000001;
  TraceLog_SessID = $00000002;
  TraceLog_SMTPRecv = $00000003;
  TraceLog_SMTPSend = $00000004;
  TraceLog_Rx = $00000005;
  TraceLog_Tx = $00000006;
  TraceLog_Rule = $00000007;
  TraceLog_Action = $00000008;
  TraceLog_Weigh = $00000009;
  TraceLog_Tag = $0000000A;

// Constants for enum TSMTPBlockReason
type
  TSMTPBlockReason = TOleEnum;
const
  SMTPBlockReason_None = $00000000;
  SMTPBlockReason_Sender = $00000001;
  SMTPBlockReason_ManyRcpt = $00000002;
  SMTPBlockReason_BadRcptAddr = $00000003;
  SMTPBlockReason_ByClient = $00000004;
  SMTPBlockReason_UnknownClient = $00000005;
  SMTPBlockReason_Relay = $00000006;
  SMTPBlockReason_BlockRule = $00000007;
  SMTPBlockReason_ByWeigh = $00000008;
  SMTPBlockReason_BadMess = $00000009;
  SMTPBlockReason_PromptDelay = $0000000A;
  SMTPBlockReason_MAX = $0000000B;

// Constants for enum SMTPFilterLogAttrDefs
type
  SMTPFilterLogAttrDefs = TOleEnum;
const
  SMTPFilterLog_Time = $00000000;
  SMTPFilterLog_ClientIP = $00000001;
  SMTPFilterLog_MessSize = $00000002;
  SMTPFilterLog_MailFrom = $00000003;
  SMTPFilterLog_RcptTo = $00000004;
  SMTPFilterLog_Subject = $00000005;
  SMTPFilterLog_State = $00000006;
  SMTPFilterLog_Rule = $00000007;
  SMTPFilterLog_Reason = $00000008;
  SMTPFilterLog_ReasonInfo = $00000009;

// Constants for enum APIHTTPCacheViewOptions
type
  APIHTTPCacheViewOptions = TOleEnum;
const
  APIHTTPCacheViewOption_UseRegExpr = $00000001;
  APIHTTPCacheViewOption_Private = $00000002;
  APIHTTPCacheViewOption_EnumAll = $00000004;
  APIHTTPCacheViewOption_Detailed = $00000008;

// Constants for enum APIDescMaintenanceOptions
type
  APIDescMaintenanceOptions = TOleEnum;
const
  APIDescMaintenance_Sort = $00000001;
  APIDescMaintenance_ResolveRequest = $00000002;
...
// *********************************************************************//
  IBasicAdmin = interface;
  IBasicAdminDisp = dispinterface;
...
// GUID:      {FBC7B5C1-5F6A-4283-BBA8-156BB1923EF5}
// *********************************************************************//
  IBasicAdmin = interface(IDispatch)
    ['{FBC7B5C1-5F6A-4283-BBA8-156BB1923EF5}']
    ...
    procedure APIMoveList(List: Integer; ItemIndex: OleVariant; NewIndex: Integer); safecall;
    procedure APISaveList(List: APIListType); safecall;
    function APIFindInList(List: Integer; Request: OleVariant): OleVariant; safecall;
  end;

// *********************************************************************//
// DispIntf:  IBasicAdminDisp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {FBC7B5C1-5F6A-4283-BBA8-156BB1923EF5}
// *********************************************************************//
  IBasicAdminDisp = dispinterface
    ['{FBC7B5C1-5F6A-4283-BBA8-156BB1923EF5}']
    function APIGetServerConfig(Request: Integer; Param2: OleVariant; Param3: OleVariant): OleVariant; dispid 401;
    function APISetServerConfig(Request: Integer; Value: OleVariant; Param2: OleVariant; 
                                Param3: OleVariant): OleVariant; dispid 402;
    function APIGetListXML(List: APIListType; Param1: OleVariant; Param2: OleVariant; 
                           AttrLevel: Integer): OleVariant; dispid 403;
    procedure APIUpdateListXML(List: APIListType; xml: OleVariant); dispid 404;
    procedure APIInsertListXML(List: APIListType; Index: OleVariant; xml: OleVariant); dispid 405;
    procedure APIDeleteListXML(List: APIListType; xml: OleVariant); dispid 406;
    procedure APIMoveList(List: Integer; ItemIndex: OleVariant; NewIndex: Integer); dispid 407;
    procedure APISaveList(List: APIListType); dispid 408;
    function APIFindInList(List: Integer; Request: OleVariant): OleVariant; dispid 409;
  end;
...
// *********************************************************************//
  ITrafInspAdmin = interface(IBasicAdmin)
    ...
    function APIHTTPCacheView(Request: OleVariant; Options: Integer; User: OleVariant; 
                              FromItem: Integer; ItemCount: Integer): OleVariant; safecall;
    function APIHTTPCacheRead(Item: Integer; const Data: IDispatch): OleVariant; safecall;
    procedure APIHTTPCacheDelete(Item: Integer); safecall;
    function APIImportDesc(List: APIListType; Item: OleVariant; Text: OleVariant; 
                           out ErrorPos: Integer; out ErrorText: OleVariant): WordBool; safecall;
    function APIExportDesc(List: APIListType; Item: OleVariant): OleVariant; safecall;
    procedure APIDescMaintenance(List: APIListType; Item: OleVariant; 
                                 Option: APIDescMaintenanceOptions); safecall;
    function APICheckDesc(List: APIListType; Item: OleVariant; Request: OleVariant): Integer; safecall;
    procedure APICreateServerCertificate(Subject: OleVariant; Month: Integer); safecall;
    function APIGetNetStat(List: Integer; Obj: OleVariant): WideString; safecall;
...
// *********************************************************************//
  ITrafInspAdminDisp = dispinterface
    ...
    function APIHTTPCacheView(Request: OleVariant; Options: Integer; User: OleVariant; 
                              FromItem: Integer; ItemCount: Integer): OleVariant; dispid 201;
    function APIHTTPCacheRead(Item: Integer; const Data: IDispatch): OleVariant; dispid 202;
    procedure APIHTTPCacheDelete(Item: Integer); dispid 218;
    function APIImportDesc(List: APIListType; Item: OleVariant; Text: OleVariant; 
                           out ErrorPos: Integer; out ErrorText: OleVariant): WordBool; dispid 303;
    function APIExportDesc(List: APIListType; Item: OleVariant): OleVariant; dispid 304;
    procedure APIDescMaintenance(List: APIListType; Item: OleVariant; 
                                 Option: APIDescMaintenanceOptions); dispid 305;
    function APICheckDesc(List: APIListType; Item: OleVariant; Request: OleVariant): Integer; dispid 306;
    procedure APICreateServerCertificate(Subject: OleVariant; Month: Integer); dispid 307;
    function APIGetNetStat(List: Integer; Obj: OleVariant): WideString; dispid 301;
    function APIGetServerConfig(Request: Integer; Param2: OleVariant; Param3: OleVariant): OleVariant; dispid 401;
    function APISetServerConfig(Request: Integer; Value: OleVariant; Param2: OleVariant; 
                                Param3: OleVariant): OleVariant; dispid 402;
    function APIGetListXML(List: APIListType; Param1: OleVariant; Param2: OleVariant; 
...
{$ENDIF}
  ...
  public
    ...
    procedure APIMoveList(List: Integer; ItemIndex: OleVariant; NewIndex: Integer);
    procedure APISaveList(List: APIListType);
    function APIFindInList(List: Integer; Request: OleVariant): OleVariant;
    function Activate(Contract: Integer; PIN1: Integer; PIN2: Integer; ChangeReq: WordBool; 
    ...
    function APIHTTPCacheView(Request: OleVariant; Options: Integer; User: OleVariant; 
                              FromItem: Integer; ItemCount: Integer): OleVariant;
    function APIHTTPCacheRead(Item: Integer; const Data: IDispatch): OleVariant;
    procedure APIHTTPCacheDelete(Item: Integer);
    function APIImportDesc(List: APIListType; Item: OleVariant; Text: OleVariant; 
                           out ErrorPos: Integer; out ErrorText: OleVariant): WordBool;
    function APIExportDesc(List: APIListType; Item: OleVariant): OleVariant;
    procedure APIDescMaintenance(List: APIListType; Item: OleVariant; 
                                 Option: APIDescMaintenanceOptions);
    function APICheckDesc(List: APIListType; Item: OleVariant; Request: OleVariant): Integer;
    procedure APICreateServerCertificate(Subject: OleVariant; Month: Integer);
    function APIGetNetStat(List: Integer; Obj: OleVariant): WideString;
...
procedure TTrafInspAdmin.APIMoveList(List: Integer; ItemIndex: OleVariant; NewIndex: Integer);
begin
...
function TTrafInspAdmin.APIFindInList(List: Integer; Request: OleVariant): OleVariant;
begin
...
function TTrafInspAdmin.APIHTTPCacheView(Request: OleVariant; Options: Integer; User: OleVariant; 
                                         FromItem: Integer; ItemCount: Integer): OleVariant;
begin
  Result := DefaultInterface.APIHTTPCacheView(Request, Options, User, FromItem, ItemCount);
end;

function TTrafInspAdmin.APIHTTPCacheRead(Item: Integer; const Data: IDispatch): OleVariant;
begin
  Result := DefaultInterface.APIHTTPCacheRead(Item, Data);
end;

procedure TTrafInspAdmin.APIHTTPCacheDelete(Item: Integer);
begin
  DefaultInterface.APIHTTPCacheDelete(Item);
end;

function TTrafInspAdmin.APIImportDesc(List: APIListType; Item: OleVariant; Text: OleVariant; 
                                      out ErrorPos: Integer; out ErrorText: OleVariant): WordBool;
begin
  Result := DefaultInterface.APIImportDesc(List, Item, Text, ErrorPos, ErrorText);
end;

function TTrafInspAdmin.APIExportDesc(List: APIListType; Item: OleVariant): OleVariant;
begin
  Result := DefaultInterface.APIExportDesc(List, Item);
end;

procedure TTrafInspAdmin.APIDescMaintenance(List: APIListType; Item: OleVariant; 
                                            Option: APIDescMaintenanceOptions);
begin
  DefaultInterface.APIDescMaintenance(List, Item, Option);
end;

function TTrafInspAdmin.APICheckDesc(List: APIListType; Item: OleVariant; Request: OleVariant): Integer;
begin
  Result := DefaultInterface.APICheckDesc(List, Item, Request);
end;

procedure TTrafInspAdmin.APICreateServerCertificate(Subject: OleVariant; Month: Integer);
begin
  DefaultInterface.APICreateServerCertificate(Subject, Month);
end;

function TTrafInspAdmin.APIGetNetStat(List: Integer; Obj: OleVariant): WideString;
begin
  Result := DefaultInterface.APIGetNetStat(List, Obj);
end;
